...
<p>
  The data processing on this website is carried out by the website operator. You can find the contact details of the operator in the section "Information on the Responsible Entity" in this privacy policy.
</p>
...
<p>
  You have the right to receive information free of charge about the origin, recipient, and purpose of your stored personal data at any time. You also have the right to request the correction or deletion of this data. If you have given consent for data processing, you can withdraw this consent at any time for the future. Additionally, under certain circumstances, you have the right to request the restriction of the processing of your personal data. Furthermore, you have the right to lodge a complaint with the competent supervisory authority.
</p>
<p>
...
<h3>All-Inkl</h3>
<p>
  The provider is ALL-INKL.COM - Neue Medien Münnich, owned by
...
<p>
  The use of All-Inkl is based on Art. 6(1)(f) GDPR. We have a legitimate interest in having our website presented as reliably as possible. If consent has been requested, the processing is solely based on Art. 6(1)(a) GDPR and § 25(1) TTDSG, to the extent that consent includes the storage of cookies or access to information on the user's end device (e.g., device fingerprinting) within the meaning of TTDSG. Consent can be revoked at any time.
</p>
...
<h3>General Information on the Legal Grounds for Data Processing on This Website</h3>
<p>
  If you have consented to data processing, we process your personal data based on Art. 6(1)(a) GDPR or Art. 9(2)(a) GDPR, if special categories of data according to Art. 9(1) GDPR are processed. In the case of explicit consent to the transfer of personal data to third countries, data processing is also based on Art. 49(1)(a) GDPR. If you have consented to the storage of cookies or to access information on your end device (e.g., via device fingerprinting), data processing is additionally based on § 25(1) TTDSG. Consent can be revoked at any time. If your data is necessary for the fulfillment of a contract or for the performance of pre-contractual measures, we process your data based on Art. 6(1)(b) GDPR. Furthermore, we process your data if it is necessary to fulfill a legal obligation based on Art. 6(1)(c) GDPR. Data processing may also be based on our legitimate interests according to Art. 6(1)(f) GDPR. The specific legal grounds for each processing will be provided in the following sections of this privacy policy.
</p>
...
<h3>Right to Object to Data Collection in Special Cases and Against Direct Marketing (Art. 21 GDPR)</h3>
<p>
  IF DATA PROCESSING IS CARRIED OUT ON THE BASIS OF ART. 6(1)(e) OR (f) GDPR, YOU HAVE THE RIGHT TO OBJECT AT ANY TIME, ON GROUNDS RELATING TO YOUR PARTICULAR SITUATION, TO THE PROCESSING OF YOUR PERSONAL DATA; THIS ALSO APPLIES TO PROFILING BASED ON THESE PROVISIONS. THE RELEVANT LEGAL BASIS FOR THE PROCESSING WILL BE FOUND IN THIS PRIVACY POLICY. IF YOU OBJECT, WE WILL NO LONGER PROCESS YOUR AFFECTED PERSONAL DATA UNLESS WE CAN DEMONSTRATE COMPELLING LEGITIMATE GROUNDS FOR THE PROCESSING THAT OVERRIDE YOUR INTERESTS, RIGHTS, AND FREEDOMS, OR THE PROCESSING IS NECESSARY FOR THE ESTABLISHMENT, EXERCISE, OR DEFENSE OF LEGAL CLAIMS (OBJECTION UNDER ART. 21(1) GDPR).
</p>
<p>
...
<p>
  You have the right to request that data, which we process based on your consent or in the fulfillment of a contract, be handed over to you or a third party in a commonly used, machine-readable format. If you request the direct transfer of the data to another controller, this will only be done to the extent technically feasible.
</p>
<h3>Information, Correction, and Deletion</h3>
<p>
  You have the right, within the framework of the applicable legal provisions, to obtain free information about your stored personal data, its origin and recipients, and the purpose of the data processing, as well as the right to correction or deletion of this data, if applicable. For this and any other questions regarding personal data, you can contact us at any time.
</p>
...
<ul>
  ...
  <li>
    If we no longer need your personal data but you require it for the assertion, defense, or enforcement of legal claims, you have the right to request the restriction of the processing of your personal data instead of deletion.
  </li>
  <li>
...
<p>
  The data you enter in the contact form will remain with us until you request its deletion, revoke your consent to storage, or the purpose for storing the data no longer applies (e.g., after your inquiry has been processed). Mandatory legal provisions – especially retention periods – remain unaffected.
</p>
<h3>Inquiries via Email, Phone, or Fax</h3>
<p>
